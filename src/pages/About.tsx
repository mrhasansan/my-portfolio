...
const skills: string[] = ["Javascript", "HTML", "CSS", "React", "Express JS", "mySQL", "RESfull API", "GitHub", "Chemistry", "Teaching", "Laboratory"];
    ...
    <div className="bg-stone-100 flex justify-center flex-col items-center mt-16 pb-20 px-4">
      ...
      <div className="bg-stone-100 flex lg:flex-row sm:flex-col">
        ...
        <div className="bg-stone-100 w-1/2 p-4 ">
          ...
          <ul className="grid lg:grid-cols-4  py-4 md:grid-cols-3 sm:grid-cols-2">
            {skills.map((item, index) => (
              <li key={index} className="box-content bg-stone-200 w-fit h-fit p-2 rounded-sm m-2 text-lg ">
                {item}
              </li>
            ))}
          </ul>
